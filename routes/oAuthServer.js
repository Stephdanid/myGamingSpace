...
function gameSearch(bodyParamSearch) {
    ...
    return postData(process.env.GET_TOKEN, {
        ...
        grant_type: `client_credentials`,
            ...
            // console.log(data); // JSON data parsed by `data.json()` call
            bodyParamSearch = `"${bodyParamSearch}"`; >>>
            >>> > 50 fc50db11250084bfcd305425b40c6be7f58394
                >>>
                >>> > main
            return postData(
                `https://api.igdb.com/v4/games`, <<
                << << < HEAD 'fields *; search ' + bodyParamSearch + '; limit 5;', { ===
                    === =
                    'fields *; search ' + bodyParamSearch + '; limit 10;',
                    { >>>
                        >>> > 5 bf57ae9686052df47d41f86b7ae98689bf815cb 'Client-ID': process.env.CLIENT_ID_TWITCH,
